const specials = [
    {
        "id": "tab-1",
        "plate": "Architecto ut aperiam autem id",
        "description": "Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka",
        "detail": "Et nobis maiores eius. Voluptatibus ut enim blanditiis atque harum sint. Laborum eos ipsum ipsa odit magni. Incidunt hic ut molestiae aut qui. Est repellat minima eveniet eius et quis magni nihil. Consequatur dolorem quaerat quos qui similique accusamus nostrum rem vero",
        "image": "assets/img/specials-1.jpg",
        "show": true
    },
    {
        "id": "tab-2",
        "plate": "Et blanditiis nemo veritatis excepturi",
        "description": "Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka",
    ...
    {
        "id": "tab-3",
        "plate": "Impedit facilis occaecati odio neque aperiam sit",
    ...
    {
        "id": "tab-4",
        "plate": "Fuga dolores inventore laboriosam ut est accusamus laboriosam dolore",
    ...
    {
        "id": "tab-5",
        "plate": "Est eveniet ipsam sindera pad rone matrelat sando reda",
